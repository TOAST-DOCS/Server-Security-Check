...
Please check [User Access Key Token](https://docs.beta-nhncloud.com/en/nhncloud/en/public-api/user-access-key-token/) to confirm the information required to use the authentication token.
